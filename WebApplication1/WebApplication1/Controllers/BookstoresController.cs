...
namespace WebApplication1.Controllers
{
    ...
    {
        private readonly deeponetwoContext _context;

        public BookstoresController(deeponetwoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Bookstores != null ? 
                          ...
                          Problem("Entity set 'deeponetwoContext.Bookstores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'deeponetwoContext.Bookstores'  is null.");
            }
            var bookstore = await _context.Bookstores.FindAsync(id);
            if (bookstore != null)
            {
